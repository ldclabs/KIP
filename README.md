...
The [Rust](https://github.com/ldclabs/anda-db/tree/main/rs/anda_cognitive_nexus) and [Cloudflare Durable Object](https://github.com/ldclabs/anda-db/tree/main/ts/kip-do) engines target KIP 2.0 drafts. Their shared suite now lives here as the [executable engine suite](./conformance/engine-suite/README.md); both passed the suite of `3251912` except its draft-vocabulary cases (anda-db `6a67d60`), and the fixtures added since — draft vocabulary, supersession scope, computed strength — stay `pending_engine` until they run them. The protocol remains `2.0-draft`, independently of tooling versions, and no real Brain learning result is claimed by structural tests.
...
| [🧪 Conformance](./conformance/README.md) | 419 executable engine cases, 343 parent vectors, 30 cognitive, 20 Memory Interface and 17 reliability scenarios, and executable contract models |
