...
> **Bundled mirror — v1.0-RC11.** This document vendors the KIP specification body for offline use by the MCP server; the version-history table is omitted. The authoritative source (with full change log) is [`SPECIFICATION.md`](https://github.com/ldclabs/KIP/blob/main/v1/SPECIFICATION.md). This v1 mirror is frozen; current KIP 2.0 development is documented at the repository root.
...
The profile defines actors and common memory products including `Event`, `Person`, `Preference`, `Insight`, `Commitment`, and `SleepTask`. Experience-learning implementations SHOULD additionally define `Experience`, `ExperienceStep`, and `Skill` as described below and in [CognitiveMemoryProfile.md](https://github.com/ldclabs/KIP/blob/main/v1/brain/CognitiveMemoryProfile.md).

Predicates ship as standalone capsules: the shared episodic/provenance relations — [involves.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/involves.kip), [mentions.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/mentions.kip), [consolidated_to.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/consolidated_to.kip), [derived_from.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/derived_from.kip) (all spanning Event and Experience) — and the Experience-specific relations — [has_step.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/has_step.kip), [caused_by.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/caused_by.kip), [derived_insight.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/derived_insight.kip), [compiled_to.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/compiled_to.kip). Load them after the type capsules they reference.
...
**[Event.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Event.kip)**

### A3.2. `Person` Concept Type

This is the generic concept for any **Actor** in the system, whether AI, human, or a group entity.

**[Person.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Person.kip)**
...
**[self.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/persons/self.kip)**
...
**[system.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/persons/system.kip)**
...
**[Preference.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Preference.kip)**
...
**[Insight.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Insight.kip)**
...
**[Commitment.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Commitment.kip)**
...
**[SleepTask.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/SleepTask.kip)**
...
**[Experience.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Experience.kip)**

See [CognitiveMemoryProfile.md](https://github.com/ldclabs/KIP/blob/main/v1/brain/CognitiveMemoryProfile.md).
...
**[ExperienceStep.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/ExperienceStep.kip)**
...
**[Skill.kip](https://github.com/ldclabs/KIP/blob/main/v1/capsules/Skill.kip)**

See [CognitiveMemoryProfile.md](https://github.com/ldclabs/KIP/blob/main/v1/brain/CognitiveMemoryProfile.md) and [ExperienceLearningArchitecture.md](https://github.com/ldclabs/KIP/blob/main/v1/brain/ExperienceLearningArchitecture.md).
