...
**Status: frozen as of 2026-09-02.** The ten documents in this directory are the pre-consolidation design drafts that led to [SPECIFICATION.md](../SPECIFICATION.md). They are kept for the reasoning behind the rules, not for the rules themselves:
