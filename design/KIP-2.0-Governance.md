...
Where `SPECIFICATION.md` has settled a permission name, error code, or wire shape, the Specification governs and this document follows it. A reference written as `Specification §N` points into that document; a bare `§N` points into this one.
